...
extra margin, not the support keepout. Component-footprint DRC checks only the
mounting keepouts generated by that board's enclosures; existing copper DRC
continues to check all keepouts. Editing placement or retention and rendering
